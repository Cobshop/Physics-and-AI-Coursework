...
namespace NCL {
	...
	public:
		...
		static bool CapsuleCapsuleIntersection(const CapsuleVolume& volumeA, const Transform& worldTransformA,
			const CapsuleVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);

		static Axis ProjectOntoAxis(const Vector3* boxPoints, const Vector3 normal);
